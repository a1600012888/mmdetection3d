...
class Detr3DCamTrackerPlusLidarVeloExtraRefine(MVXTwoStageDetector):
    ...
    def __init__(self,
        ...
        super(Detr3DCamTrackerPlusLidarVeloExtraRefine,
        ...
        self.ref_update = nn.Sequential(
                nn.Linear(self.embed_dims, 3)
                )


    def velo_update(self, ref_pts, velocity, ref_update, l2g_r1, l2g_t1, l2g_r2, l2g_t2,
                    time_delta):
        '''
        Args:
    ...
    def _forward_single(self, points, img, radar, img_metas, track_instances,
        ...
        if l2g_r2 is not None:
            ref_update = self.ref_update(track_instances.output_embedding)
            ref_pts = self.velo_update(
                last_ref_pts[0], velo, ref_update, l2g_r1, l2g_t1, l2g_r2, l2g_t2,
    ...
    def _inference_single(self, points, img, radar, img_metas, track_instances,
        ...
        if l2g_r2 is not None and len(active_inst) > 0 and l2g_r1 is not None:
            ...
            ref_update = self.ref_update(active_inst.output_embedding)
            ref_pts = self.velo_update(
                ref_pts, velo, ref_update, l2g_r1, l2g_t1, l2g_r2, l2g_t2,
                time_delta=time_delta)
