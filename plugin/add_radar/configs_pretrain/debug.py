                ...
                transformerlayers=dict(
                    ...
                    attn_cfgs=[
                        dict(
                            ...
                            dropout=0.1),
                        dict(
                            type='Detr3DCamRadarSparseCrossAtten',
...
data = dict(
    ...
    train=dict(
        ...
        # dataset=dict(
            type=dataset_type,
            data_root=data_root,
            ann_file=data_root + 'radar_nuscenes_sweeps_infos_train_radar.pkl',
    ...
    val=dict(
            ...
            ann_file=data_root + 'radar_nuscenes_sweeps_infos_val_radar.pkl',),
    test=dict(
            type=dataset_type,
            pipeline=test_pipeline, classes=class_names, modality=input_modality,
            ann_file=data_root + 'radar_nuscenes_sweeps_infos_val_radar.pkl',),)
