...
class Detr3DCamTrackerPlusLidarVeloFullFrame(MVXTwoStageDetector):
    ...
    def __init__(self,
        ...
        super(Detr3DCamTrackerPlusLidarVeloFullFrame,
    ...
    def velo_update(self, ref_pts, velocity, l2g_r1, l2g_t1, l2g_r2, l2g_t2,
        ...
        reference_points = reference_points + velo_pad * time_delta * 5.5
