...
model = dict(
    ...
    pts_bbox_head=dict(
        type='DeformableDETR3DCamPtsRadarHead',
        num_query=600,
        num_classes=10,
        in_channels=256,
        ...
        as_two_stage=False,
        transformer=dict(
            type='Detr3DCamPtsRadarTransformer',
            decoder=dict(
                type='Detr3DCamPtsRadarTransformerDecoder',
                num_layers=6,
                ...
                transformerlayers=dict(
                    ...
                    attn_cfgs=[
                        dict(
                            ...
                            dropout=0.1),
                        dict(
                            type='Detr3DCamPtsRadarCrossAtten',
...
optimizer = dict(
    ...
    paramwise_cfg=dict(
        custom_keys={
            ...
            'radar_encoder': dict(lr_mult=0.1)
        }),
    weight_decay=0.01)
...
load_from = '/public/MARS/models/surrdet/pts_img_radar_models/img_radar_3504_01voxel_reduce4_beamv5_q6_epoch_38_4210.pth'
