...
CUDA_VISIBLE_DEVICES=0,1,2,3 bash tools/dist_train.sh plugin/radar/configs/depth_sup_radar.py 4 #--resume-from /home/zhangty/projects/mmdetection3d/work_dirs/res50_c4x_t1x_1m_steplr_crop/latest.pth
