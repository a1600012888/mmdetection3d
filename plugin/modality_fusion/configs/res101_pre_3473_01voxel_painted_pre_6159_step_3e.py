...
model = dict(
    ...
    pts_voxel_encoder=dict(type='HardSimpleVFE', num_features=15),
...
train_pipeline = [
    dict(
        type='LoadPaintedPointsFromFile',
        coord_type='LIDAR',
        load_dim=15,
        use_dim=15,
        file_client_args=file_client_args),
...
load_from = '/public/MARS/models/surrdet/pts_img_models/img_3473_01voxel_painted_q6_epoch_18_6159.pth'
