...
model = dict(
    ...
    radar_neck=dict(
        ...
        num_outs=3),
    pts_bbox_head=dict(
        type='DeformableDETR3DRadarHead',
        num_query=600,
        num_classes=10,
        in_channels=128,
        ...
        as_two_stage=False,
        transformer=dict(
            type='Detr3DRadarTransformer',
            decoder=dict(
                type='Detr3DRadarTransformerDecoder',
                num_layers=6,
...
load_from='work_dirs/radar_only_08pillar_128d_step_20e/epoch_9.pth'
