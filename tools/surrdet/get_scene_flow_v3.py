...
def get_sf_ann(ann_token:str, timestamp, points, nusc):
    ...
    if (not has_next) and (not has_prev):
        return None, None, None, None, box
    ...
    if next_ann_token is not '':
        ...
        #print(next_time*1e-6 - timestamp*1e-6)
        valid_points_next = valid_points
    else:
        sf_from_next = None
        valid_points_next = None
    ...
    if prev_ann_token is not '':
        ...
        valid_points_prev = valid_points
    else:
        sf_from_prev = None
        valid_points_prev = None

    return valid_points_next, sf_from_next, valid_points_prev, sf_from_prev, box
