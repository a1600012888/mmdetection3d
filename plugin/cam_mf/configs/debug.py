...
model = dict(
    ...
    pts_bbox_head=dict(
        type='DeformableDETR3DCamMulFrameHead',
        num_query=300,
        num_classes=10,
        in_channels=256,
                ...
                transformerlayers=dict(
                    ...
                    attn_cfgs=[
                        dict(
                            ...
                            dropout=0.1),
                        dict(
                            type='Detr3DCamCrossAttenMulFrame',
                            pc_range=point_cloud_range,
                            num_points=2,
                            num_frames=2,
                            use_frame_offsets=True,
...
dataset_type = 'NuScenesMulFrameDataset'
