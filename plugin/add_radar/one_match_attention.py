...
class Detr3DCamRadarOneMatchCrossAtten(BaseModule):
    ...
    def __init__(self,
        ...
        super(Detr3DCamRadarOneMatchCrossAtten, self).__init__(init_cfg)
        ...
        self.radar_match_thre = radar_match_thre
    ...
    def forward(self,
        ...
        # print(_value.mean().item(), _value.min().item(), _value.max().item())
        with torch.no_grad():
            mask = (_value * -1.0) > self.radar_match_thre
            ...
            top_mask = torch.logical_and(top_mask, mask).detach()
