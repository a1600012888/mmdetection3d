...
model = dict(
    ...
    pts_backbone=dict(
        ...
        layer_nums=[5, 5],
        layer_strides=[1, 2],
        norm_cfg=dict(type='naiveSyncBN2d', eps=1e-3, momentum=0.01, requires_grad=False),
    ...
    pts_bbox_head=dict(
        ...
        transformer=dict(
            ...
            decoder=dict(
                type='Detr3DCamTransformerDecoderModalityFusion',
                num_layers=6,
...
#load_from = '/public/MARS/models/surrdet/pts_img_models/img_3473_01voxel_reduce4_beamv4_q6_epoch_38_4039.pth'
#load_from = '/home/chenxy/mmdetection3d/work_dirs/res101_pre_01voxel_pre_step_3e/epoch_1.pth'
#load_from = '/public/MARS/models/surrdet/pts_img_models/img_3567_01voxel_reduce4_beamv5_q6_epoch_38_4210.pth'
#load_from = '/public/MARS/models/surrdet/pts_img_models/img_3983_01voxel_reduce4_beamv5_q6_epoch_38_4210.pth'
load_from = 'work_dirs/detr3d_pre_3983_01voxel_pre_reduce4_beamv5_4210_step_10e/epoch_3.pth'