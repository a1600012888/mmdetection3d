...
data = dict(
    ...
    train=dict(
        ...
        # dataset=dict(
            ...
            box_type_3d='LiDAR'),
    # ),
    val=dict(pipeline=test_pipeline, classes=class_names, modality=input_modality, pred_attr=False),
    test=dict(pipeline=test_pipeline, classes=class_names, modality=input_modality, pred_attr=False))
