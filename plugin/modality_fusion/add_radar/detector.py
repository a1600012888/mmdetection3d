...
class Detr3DCamPtsRadar(MVXTwoStageDetector):
    ...
    def forward_pts_train(self,
        ...
        """
        outs = self.pts_bbox_head(img_feats, pts_feats, radar_feats, img_metas)
    ...
    def forward_train(self,
        ...
        """
        img_feats, pts_feats, radar_feats = self.extract_feat(points, img=img, img_metas=img_metas, radar=radar)
        losses = dict()
        losses_pts = self.forward_pts_train(img_feats, pts_feats, radar_feats, gt_bboxes_3d,
                                            gt_labels_3d, img_metas,
                                            gt_bboxes_ignore)
        losses.update(losses_pts)
        return losses

    def simple_test_pts(self, img_feats, pts_feats, radar_feats, img_metas, rescale=False):
    ...
    def simple_test(self, points, img_metas, img=None, radar=None, rescale=False):
        ...
        bbox_pts = self.simple_test_pts(
            img_feats, pts_feats, radar_feats, img_metas, rescale=rescale)
    ...
    def forward_test(self, points, img_metas, img=None, radar=None, **kwargs):
        """
        Args:
        ...
        if num_augs == 1:
            ...
            return self.simple_test(points[0], img_metas[0], img[0], radar[0], **kwargs)
        else:
            return self.aug_test(points, img_metas, img, **kwargs)

@DETECTORS.register_module()
class Detr3DRadar(MVXTwoStageDetector):
    """Base class of Multi-modality VoxelNet."""
    ...
    def extract_feat(self, points, img, radar, img_metas):
        ...
        radar_feats = [feat.unsqueeze(dim=1) for feat in radar_feats]
        #for radar_feat in radar_feats:
        #    print(radar_feat.size())
        return (None, None, radar_feats)
    ...
    def forward_pts_train(self,
        ...
        Returns:
            dict: Losses of each branch.
        """
        outs = self.pts_bbox_head(radar_feats, img_metas)
        loss_inputs = [gt_bboxes_3d, gt_labels_3d, outs]
        losses = self.pts_bbox_head.loss(*loss_inputs)
        return losses
...
@DETECTORS.register_module()
class Detr3DCamRadar(MVXTwoStageDetector):
    """Base class of Multi-modality VoxelNet."""
    ...
    def forward_pts_train(self,
        ...
        Returns:
            dict: Losses of each branch.
        """
        outs = self.pts_bbox_head(img_feats, radar_feats, img_metas)
        loss_inputs = [gt_bboxes_3d, gt_labels_3d, outs]
        losses = self.pts_bbox_head.loss(*loss_inputs)
        return losses
...
@DETECTORS.register_module()
class Detr3DCamPtsRadarv2(MVXTwoStageDetector):
    """Base class of Multi-modality VoxelNet."""
