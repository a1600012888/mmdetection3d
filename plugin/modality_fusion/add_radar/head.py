...
class DeformableDETR3DCamPtsRadarHead(DETRHead):
    ...
    def __init__(self,
        ...
        super(DeformableDETR3DCamPtsRadarHead, self).__init__(
    ...
    def forward(self, mlvl_feats, pts_feats, radar_feats, img_metas):
        """Forward function.
        Args:
...
@HEADS.register_module()
class DeformableDETR3DRadarHead(DETRHead):
    """Head of DeformDETR3DCam. 
    Args:
        with_box_refine (bool): Whether to refine the reference points
            in the decoder. Defaults to False.
    ...
    def __init__(self,
        ...
        self.loss_bbox_scale = loss_bbox_scale
        self.num_cls_fcs = num_cls_fcs - 1
        super(DeformableDETR3DRadarHead, self).__init__(
            *args, transformer=transformer, **kwargs)
        self.register_buffer('code_weights', torch.tensor(
            code_weights, requires_grad=False)) 
        self.per_scene_noise = per_scene_noise
    ...
    def forward(self, radar_feats, img_metas):
        """Forward function.
        Args:
            mlvl_feats (tuple[Tensor]): Features from the upstream
                network, each is a 5D-tensor with shape
        ...
        batch_size = radar_feats[0].size(0)
...
@HEADS.register_module()
class DeformableDETR3DCamRadarHead(DETRHead):
    """Head of DeformDETR3DCam. 
    Args:
        with_box_refine (bool): Whether to refine the reference points
            in the decoder. Defaults to False.
    ...
    def __init__(self,
        ...
        self.loss_bbox_scale = loss_bbox_scale
        self.num_cls_fcs = num_cls_fcs - 1
        super(DeformableDETR3DCamRadarHead, self).__init__(
            *args, transformer=transformer, **kwargs)
        self.register_buffer('code_weights', torch.tensor(
            code_weights, requires_grad=False)) 
        self.per_scene_noise = per_scene_noise
