...
class Detr3DCamMulFrame(MVXTwoStageDetector):
    ...
    def extract_img_feat(self, img, img_metas):
        ...
        for _frame in range(T):
            ...
            for img_feat in img_feats:
                ...
                img_feats_reshaped.append(img_feat.view(B, T, N, C, H, W)[:, _frame, ...])

            frame_feats_list.append(img_feats_reshaped)
        return frame_feats_list
