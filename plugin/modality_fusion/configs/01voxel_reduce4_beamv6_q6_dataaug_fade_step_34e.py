...
eval_pipeline = [
    dict(
        ...
        file_client_args=file_client_args),
    dict(
        type='LoadTeducedPointsFromMultiSweeps',
        sweeps_num=9,
        use_dim=[0, 1, 2, 3, 4],
        reduce_beams_to=4,
        file_client_args=file_client_args,
...
load_from = '/home/chenxy/mmdetection3d/work_dirs/01voxel_reduce4_beamv6_q6_dataaug_step_40e/epoch_32.pth'
