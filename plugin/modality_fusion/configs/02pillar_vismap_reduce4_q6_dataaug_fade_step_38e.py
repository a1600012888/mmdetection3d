...
model = dict(
    ...
    visibility_feature_extractor=dict(
        voxel_size=voxel_size,
...
train_pipeline = [
    ...
    dict(
        type='LoadReducedPointsFromMultiSweepsVisMap',
        sweeps_num=9,
        use_dim=[0, 1, 2, 3, 4],
        reduce_beams_to=4,
        chosen_beam_id=[8, 9, 10, 11],
    ...
    #dict(type='ObjectSampleVisMap', db_sampler=db_sampler),
    dict(
    ...
    dict(type='PointsRangeFilterVisMap', point_cloud_range=point_cloud_range),
    dict(type='ObjectRangeFilter', point_cloud_range=point_cloud_range),
    dict(type='ObjectNameFilter', classes=class_names),
    dict(type='CreateVisibilityMap',
        voxel_size=voxel_size,
        pc_range=point_cloud_range),
    ...
    dict(type='Collect3D', keys=['points', 'gt_bboxes_3d', 'gt_labels_3d', 'img', 'logodds'])
]
test_pipeline = [
    dict(
        type='LoadReducedPointsFromFile',
    ...
    dict(
        ...
        transforms=[
            ...
            dict(
                ...
                with_label=False),
            dict(type='Collect3D', keys=['points', 'img', 'logodds'])
        ])
]
...
load_from='work_dirs/02pillar_vismap_reduce4_q6_dataaug_step_40e/epoch_36.pth'
