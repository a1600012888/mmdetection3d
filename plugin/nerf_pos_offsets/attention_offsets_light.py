...
class Detr3DCamCrossAttenOffsetsLight(BaseModule):
    ...
    def __init__(self,
                 ...
                 norm_cfg=None,
                 init_cfg=None):
        super(Detr3DCamCrossAttenOffsetsLight, self).__init__(init_cfg)
        ...
        self.pos_embed_subnet = nn.Sequential(
            nn.Linear(3*pos_embed_dims, 3*pos_embed_dims),
            nn.LayerNorm(3*pos_embed_dims),
            nn.ReLU(),
