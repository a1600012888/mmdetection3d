...
class Detr3DCamTransformerPoint(BaseModule):
    ...
    def __init__(self,
                 ...
                 **kwargs):
        super(Detr3DCamTransformerPoint, self).__init__(**kwargs)
...
class Detr3DCamTransformerDecoderPoint(TransformerLayerSequence):
    ...
    def __init__(self, *args, return_intermediate=False,  **kwargs):
        ...
        super(Detr3DCamTransformerDecoderPoint, self).__init__(*args, **kwargs)
