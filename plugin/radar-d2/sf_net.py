...
class SFNet(nn.Module):
    ...
    def __init__(self, **kwargs):
        ...
        self.conv1 = conv(8, 16, 3, 1, 1)
        self.conv_block1 = IFBlock(in_planes=16, c=128, scale=4)
        self.conv_block2 = IFBlock(in_planes=128, c=64, scale=2)
        self.conv_block3 = IFBlock(in_planes=64, c=32, scale=1)
        self.final_head = nn.Conv2d(32, 3, 3, 1, 1)
