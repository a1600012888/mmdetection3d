...
class Detr3DCamTransformerModalityFusion(BaseModule):
    ...
    def __init__(self,
                 ...
                 **kwargs):
        super(Detr3DCamTransformerModalityFusion, self).__init__(**kwargs)
...
class Detr3DCamTransformerDecoderModalityFusion(TransformerLayerSequence):
    ...
    def __init__(self, *args, return_intermediate=False,  **kwargs):
        ...
        super(Detr3DCamTransformerDecoderModalityFusion, self).__init__(*args, **kwargs)
